...
function buildJunctionGauntlet() {
    ...
    const cells = buildBranchingMaze(30, 165, 1, 94, 2, 4, coreObstacles, edgeObstacles, 41001, { solid: true });
    ...
    api.setBarrier("mzedge_north", 0, 0, 180, 1, true);
    ...
    api.spawnNpc("android", spots[48].col, spots[48].row);
    api.spawnNpc("cyber_rogue", spots[49].col, spots[49].row);
    api.spawnNpc("gnome_engineer", spots[50].col, spots[50].row);

    if (!api.getVar("hostage_spawned", false)) {
        api.setVar("hostage_spawned", true);
        api.spawnNpc("merchant", spots[51].col, spots[51].row);
    }

    if (api.getVar("gauntlet_loot_spawned", false))
        return;
    api.setVar("gauntlet_loot_spawned", true);
    api.spawnItem("repair_kit", spots[52].col, spots[52].row);
    api.spawnItem("spool_of_copper_wire", spots[53].col, spots[53].row);
    api.spawnItem("stamina_draught", spots[54].col, spots[54].row);
    api.spawnItem("health_potion", spots[55].col, spots[55].row);
    api.spawnItem("health_potion", spots[56].col, spots[56].row);
    api.spawnItem("tech_chip", spots[57].col, spots[57].row);
    api.spawnItem("small_ingot", spots[58].col, spots[58].row);
    api.spawnItem("health_potion", spots[59].col, spots[59].row);
    api.spawnItem("health_potion", spots[60].col, spots[60].row);
    api.spawnItem("health_potion", spots[61].col, spots[61].row);
    api.spawnItem("health_potion", spots[62].col, spots[62].row);
    api.spawnItem("health_potion", spots[63].col, spots[63].row);
